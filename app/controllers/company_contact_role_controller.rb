...
#  2 - Update
#
class CompanyContactRoleController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_roles
    
    render 'company_contact/view_company_contact_roles.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_role
    
    render 'company_contact/view_company_contact_role.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_role_filtered
    
    render 'company_contact/view_company_contact_role_filtered.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_role_description
    
    render 'company_contact/view_company_contact_role_description.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_role_agents
    
    render 'company_contact/view_company_contact_role_agents.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_role_candidates
    
    render 'company_contact/view_company_contact_role_candidates.html', :layout => 'company_contact_main_layout'
