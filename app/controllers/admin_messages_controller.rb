...
class AdminMessagesController < ApplicationController
  ...
  def admin_view_inbox_messages
    ...
    render 'admin/messages/view_messages.html', :layout => 'admin'
  end
  
  def admin_view_sent_messages
  ...
  def admin_view_inbox_message
    ...
    render 'admin/messages/view_message.html', :layout => 'admin'
  end
  
  def admin_view_sent_message
    session[:page] = "sent_messages"
  ...
  def admin_reply_to_message
    ...
    render 'admin/messages/reply_to_message.html', :layout => 'admin'
  end
  
  def admin_send_reply_to_message
    ...
    respond_to do |format|
      ...
      if params[:cancel]
        ...
        format.html { redirect_to :action => :admin_view_inbox_message, :controller => :admin_messages }
        ...
        begin
          ...
          raise 'ERROR #2' if !send_message(@params_h, nil, true, params[:message_type_id].to_s.to_i, 2)          
          
          flash[:notice_hold] = 'Message was sent successfully!'
          format.html { redirect_to :action => :admin_view_inbox_messages, :controller => :admin_messages }
          ...
          format.html { render 'admin/messages/reply_to_message.html', :layout => 'admin' }
