...
#  2 - Update
#
class CompanyContactMessageController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_candidate_filtered
    
    render 'company_contact/candidate/view_company_contact_candidate_filtered.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_candidate_filtered_candidates
    
    render 'company_contact/candidate/view_company_contact_candidate_filtered_candidates.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def invite_company_contact_agents_by_search_step_1_agencies
    
    render 'company_contact/invitation/company_contact_invite_people_by_search_step_1_agencies.html', :layout => 'company_contact_main_layout'
    
  end
  
  def invite_company_contact_agents_by_search_step_2
    
    render 'company_contact/invitation/company_contact_invite_people_by_search_step_2.html', :layout => 'company_contact_main_layout'
    
  end
  
  def view_company_contact_uncategorised_senders
    
    render 'company_contact/message/company_contact_uncategorised_senders.html', :layout => 'company_contact_main_layout'
    
  end
  
  def review_company_contact_categorised_senders
    
    render 'company_contact/message/company_contact_review_categorised_senders.html', :layout => 'company_contact_main_layout'
    
  end
  
  def manage_company_contact_message_associations
    
    render 'company_contact/message/company_contact_manage_message_associations.html', :layout => 'company_contact_main_layout'
    
  end
  
  def add_company_contact_message_association
    
    render 'company_contact/message/company_contact_add_message_association.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def invite_company_contact_agents_by_email_step_1
    
    render 'company_contact/invitation/company_contact_invite_people_by_email_step_1.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def invite_company_contact_agents_by_email_step_2
    
    render 'company_contact/invitation/company_contact_invite_people_by_email_step_2.html', :layout => 'company_contact_main_layout'
    
  end
  
  def invite_company_contact_agents_by_email_step_3
    
    render 'company_contact/invitation/company_contact_invite_people_by_email_step_3.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_candidate_candidates
    
    render 'company_contact/candidate/view_company_contact_candidate_candidates.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_candidate_roles
    
    render 'company_contact/candidate/view_company_contact_candidate_roles.html', :layout => 'company_contact_main_layout'
