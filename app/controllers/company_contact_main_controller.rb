...
#  2 - Update
#
class CompanyContactMainController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
 ...
 #
  ...
  def view_company_contact_home
    
    render 'company_contact/view_company_contact_home.html', :layout => 'company_contact_main_layout'
