...
#  2 - Update
#
class CompanyContactInvitationController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
  ...
  def invite_company_contact_agents_by_search_step_1_agents
    
    render 'company_contact/invitation/company_contact_invite_people_by_search_step_1_agents.html', :layout => 'company_contact_main_layout'
