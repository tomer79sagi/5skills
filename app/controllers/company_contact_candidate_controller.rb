...
#  2 - Update
#
class CompanyContactCandidateController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_candidate
    
    render 'company_contact/candidate/view_company_contact_candidate.html', :layout => 'company_contact_main_layout'
