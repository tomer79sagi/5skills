...
#  2 - Update
#
class CompanyContactAgentController < ApplicationController
...
#    @quick_add_companies[0,0] = [['-- N/A --',0], ["-- New Company --", -2],['', -1]]
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_agent_filtered
    
    render 'company_contact/agent/view_company_contact_agent_filtered.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_agent_filtered_candidates
    
    render 'company_contact/agent/view_company_contact_agent_filtered_candidates.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_agent
    
    render 'company_contact/agent/view_company_contact_agent.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_agent_candidates
    
    render 'company_contact/agent/view_company_contact_agent_candidates.html', :layout => 'company_contact_main_layout'
  ...
  # VIEW APPLICATIONS
  #
  def view_company_contact_agent_roles
    
    render 'company_contact/agent/view_company_contact_agent_roles.html', :layout => 'company_contact_main_layout'
